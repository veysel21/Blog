...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{asset('back/')}}/index.html">
            ...
            <div class="sidebar-brand-text mx-3">VBlog Admin</div>
        </a>
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" href="{{asset('back/')}}/#" data-toggle="collapse"
        ...
        <div id="content">
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown no-arrow mx-1">
                        ...
                        <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                            ...
                            <a class="dropdown-item text-center small text-gray-500" href="{{asset('back/')}}/#">Read
                                More Messages</a>
                        </div>
                    </li>
                    ...
                    <li class="nav-item dropdown no-arrow">
                        ...
                        <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                            ...
                            <a class="dropdown-item" href="{{asset('back/')}}/#">
                            ...
                            <a class="dropdown-item" href="{{asset('back/')}}/#" data-toggle="modal"
            ...
            <div class="container-fluid">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    ...
                    <a href="{{asset('back/')}}/#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
